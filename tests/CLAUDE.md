...
Node.js (13): collect-signals, config-doc-drift, dash-agents-panel, dash-extra, domain-map-drift, force-model-policy, lock, mcp-fleet, packaging-portability, proposals, scaffold-hook-install, scaffold-onboarding, wizard.
Python (38): Serve/UI (test_agent_detail_roundtrip, test_agents, test_api_state, test_api_tracker, test_collectors, test_launch_tui, test_render, test_serve, test_serve_agent_security, test_serve_sse, test_serve_wave8_fixes, test_sse_unit, test_ui_cost, test_wave13_ui_correctness), Tracker (test_tracker_csrf, test_tracker_isolation, test_tracker_sse), Tools/Scripts/Individual (test_alert_bridge, test_ci_merge_wait, test_healthcheck, test_metrics_gate, test_rotate_logs, test_secret_scan, test_self_stats, test_state_store, test_stall_check, test_symlink_guard, test_tools_buildlog, test_tools_ensure_state, test_tools_eod_sweep, test_tools_fleet_ledger, test_tools_heartbeat, test_tools_importable, test_tools_inbox_drain, test_tools_orchestrator_status, test_tools_power_selftest, test_tools_prepublish_scan, test_tools_scanner_selftest).
