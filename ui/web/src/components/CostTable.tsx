      ...
      <table className="cost-table" data-testid={TESTIDS.costTable}>
        ...
        <thead>
          <tr>
            ...
            <th scope="col" className="col-numeric verdict-col-header">
              FAILED
            </th>
            <th scope="col" className="col-numeric verdict-col-header">
              EMPTY
          ...
          {modelIds.map((modelId) => {
            ...
            return (
              <tr key={modelId}>
                ...
                <td className="col-numeric verdict-failed verdict-cell">{stats.verdicts.FAILED}</td>
                <td className="col-numeric verdict-empty verdict-cell">{stats.verdicts.EMPTY}</td>
                <td className="col-numeric verdict-hung verdict-cell">{stats.verdicts.HUNG}</td>
