...
**Date**: 2026-07-23
**Challenger Model**: gpt-5.6-luna (OpenAI-compatible)
...
| dryrun-blocked | real_defect | real_defect | ✓ | 0.96 | ✓ |
| uninstall-exit0 | real_defect | real_defect | ✓ | 0.95 | ✓ |
...
| hardcoded-username | real_defect | real_defect | ✓ | 0.99 | ✓ |
| audit-log-observability | real_defect | enhancement_opportunity | ✗ | 0.88 | ✓ |
...
| fixreview-parents1 | false_positive | false_positive | ✓ | 0.92 | ✓ |
| fixreview-backtick-test | real_defect | false_positive | ✗ | 0.94 | ✓ |
