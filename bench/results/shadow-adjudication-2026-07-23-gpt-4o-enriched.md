...
- **Overall Agreement (vs incumbent)**: 37.5%
- **Real Defect Subset Agreement**: 44.4%
...
- >=80% agreement on gt=real_defect items: **FAIL** (44.4%)
...
| uninstall-exit0 | enhancement_opportunity | real_defect | ✗ | 0.85 | ✓ |
...
| hardcoded-username | enhancement_opportunity | real_defect | ✗ | 0.90 | ✓ |
...
| ps1-syntax-gate | undetermined | enhancement_opportunity | ✗ | 0.50 | ✓ |
| test-hardcoded-path | enhancement_opportunity | real_defect | ✗ | 0.90 | ✓ |
| fixreview-parents1 | undetermined | false_positive | ✗ | 0.60 | ✓ |
